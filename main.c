...
void exibe_menu() {
    ...
    printf("6. Emprestar Filme\n");
    printf("7. Devolver Filme\n");
    printf("8. Listar Todos os Usuarios\n");
    printf("9. Listar Todos os Filmes\n");
    printf("0. Sair\n");
    printf("====================================================\n");
...
int main() {
    ...
    if (arq_filmes) {
        ordena_filmes_por_codigo(arq_filmes);
        fclose(arq_filmes);
    }
    ...
    do {
        ...
        switch (opcao) {
            ...
            case 5: ordenar_por_ano(); break;
            case 6: emprestar_filme(); break;
            case 7: devolver_filme(); break;
            case 8: listar_usuarios(); break;
            case 9: listar_filmes(); break;
